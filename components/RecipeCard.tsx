...
const RecipeCard: React.FC<RecipeCardProps> = ({ recipe, onSelect, onAddToShoppingList, fridgeIngredients }) => {
        ...
        {missingIngredients.length > 0 && (
            <div className="mb-4 flex-grow">
                <div className="flex justify-between items-center">
                    ...
                    className="text-xs bg-amber-500/20 text-amber-300 px-2 py-1 rounded hover:bg-amber-500/40"
                    >
                    Add All to List
                    </button>
                </div>
                            ...
                            <div className="flex justify-between items-center gap-2">
                                ...
                                <div className="flex items-center gap-2 flex-shrink-0">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center w-5 h-5 text-xs bg-amber-500/20 text-amber-300 rounded-full hover:bg-amber-500/40"
