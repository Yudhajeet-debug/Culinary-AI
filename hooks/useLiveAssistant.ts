                    ...
                    try {
                        switch (fc.name) {
                            ...
                            case 'getIngredientSubstitution':
                                result = await callbacks.onGetSubstitution(fc.args.ingredient);
                                break;
                            case 'addToShoppingList':
                                callbacks.onAddToShoppingList(fc.args.item);
                                result = `Successfully added ${fc.args.item} to the shopping list.`;
                                break;
                        }
